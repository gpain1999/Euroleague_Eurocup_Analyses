...
with col2:
    ...
    **I_PER** is an advanced metric that evaluates a player's performance by balancing **quantity and quality**.  
    ...
    Min_I_PER =["-∞", -1.2, -0.6, -0.3, -0.1, 0.1, 0.3, 0.5, 0.7, 0.9, 1, 1.2, 1.4, 1.5, 1.7, 2, 2.2, 2.5, 2.8, 3.1, 3.9]
    Max_I_PER = [-1.3, -0.7, -0.4, -0.2, 0, 0.2, 0.4, 0.6, 0.8, 0.9, 1.1, 1.3, 1.4, 1.6, 1.9, 2.1, 2.4, 2.7, 3, 3.8, "+∞"]
