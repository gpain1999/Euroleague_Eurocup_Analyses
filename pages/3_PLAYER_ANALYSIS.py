...
st.dataframe(styled_df,height=38*len(df_resultat), use_container_width=True)


st.header("Duo +/-")
st.dataframe(styled_result_pm,height=38*len(result_pm), use_container_width=True)
