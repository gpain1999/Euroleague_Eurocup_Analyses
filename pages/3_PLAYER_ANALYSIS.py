...
st.dataframe(styled_df,height=40*len(df_resultat), use_container_width=True)


st.header("Duo +/-")
st.dataframe(styled_result_pm,height=40*len(result_pm), use_container_width=True)
