...
print(df)
titre = "BEST TRIOS +/- AFTER 6 ROUNDS"
...
f.create_infographie(df,titre,season,competition,images_dir,infographie_dir,name_image = f"BEST_TRIO_DUO_R1_R6",percent_time = True)
